...
<body>
    ...
    <div data-role="page" id="glowna">
        ...
        <div class="backButton">
			...
			<a href="addexp.php"><img src="css/images/plus-square.png" alt="dodaj wydatek"></a>dodaj wydatek</br>
        ...
        <div class="wydatkiSkrot">
            ...
            <a href="bilans2.php">Wydatki w tym miesiącu</a></br>
			<?php
    session_start();
        ...
        $sql = "SELECT * FROM `koszty`  WHERE `email`=?";
        ...
        // echo $user['id'];
			...
			if ($result->num_rows > 0) 
			{
				...
				echo "<tr>
					<td>Data</td>	<td>Nazwa</td><td>typ</td><td>kwota</td>
					</tr>";
				// output data of each row
				 while($row = $result->fetch_assoc())
				{
					echo "<tr>
					<td>".$row["data"]."</td>	<td>".$row["nazwa"]."</td><td>".$row["typ"]."</td><td>".$row["kwota"]."</td>
					</tr>";
