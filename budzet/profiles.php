    ...
    <div data-role="page" id="glowna">
        ...
        <div id="menuBox">
            ...
            <ul id="menu">
                ...
                <li><a href="#"><img src="css/images/Alert.png" alt="saldo"></a>
                <li><a href="kalendarz.php"><img src="css/images/Explore.png" alt="kalendarz"></a>
                <li><a href="#"><img src="css/images/Profile.png" alt="skarbonka"></a>
                <li><a href="#"><img src="css/images/SettingsWh.png" alt="inne"></a>
            </ul>
        </div>
